...
5. Before creating an issue, you MUST check if it already exists. Use your github tool to search for issues with: `is:issue "emulator release notes" "[X.Y.Z]" repo:${{ github.repository }}`, replacing `[X.Y.Z]` with the SDK version you found.
