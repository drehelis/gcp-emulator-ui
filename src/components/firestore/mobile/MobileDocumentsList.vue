  ...
  <div class="h-full flex flex-col bg-white dark:bg-gray-800">
    ...
    <div class="flex-shrink-0 p-4 border-b border-gray-200 dark:border-gray-700">
      <div class="flex items-center space-x-3">
        ...
        <div class="flex-1 min-w-0">
          <h1 class="text-lg font-semibold text-gray-900 dark:text-white truncate">{{ collectionId }}</h1>
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div v-else-if="documents.length === 0" class="p-8 text-center">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">Add your first document to this collection.</p>
      </div>
