    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">
          Select a project to manage its services
        </p>
      </div>
      ...
      <!-- Error state -->
      <div v-else-if="projectsStore.hasError" class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-6">
        <div class="flex">
          ...
          <div class="ml-3">
            <h3 class="text-sm font-medium text-red-800 dark:text-red-200">Failed to load projects</h3>
            <p v-if="projectsStore.state.error" class="text-red-600 dark:text-red-300 text-sm mt-1">{{ projectsStore.state.error }}</p>
            <button
              @click="loadProjects"
      ...
      <!-- Empty state -->
      <div v-else-if="projectsStore.projectList.length === 0" class="bg-white dark:bg-gray-800 shadow rounded-lg p-12 text-center">
        <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7M3 7a2 2 0 012-2h14a2 2 0 012 2m0 0V5a2 2 0 00-2-2H5a2 2 0 00-2 2v2" />
        </svg>
        <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No projects available</h3>
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Select a project to get started managing your GCP emulator services</p>
      </div>
